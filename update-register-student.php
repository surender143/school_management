...
if($_SERVER['REQUEST_METHOD']=='POST' && isset($student_registration['submit'])){
    ...
    $student_registration_data ="UPDATE `student-registration` SET district='$district',tehsil='$tehsil',block='$block',village_ward='$village',panchayat_municipal='$panchayat',candidate_name='$candidate',mothers_name='$mothers',fathers_name='$fathers',occupation='$occupation',religion='$religion',pincode=$pincode, mobile=$mobile, aadhaar_no=$aadhaar, id_type='$attach',dob=$birth, community='$community',general='$general',asha='$asha',abled='$differently',candidate_type='$candidate_type',name_of_institute_where_studying='$institute' WHERE id=$id";
    $con->query($student_registration_data);
    $_SESSION['success']="student updated successfull";
