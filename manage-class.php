...
?>
<?php
    $count = "SELECT count(*) as total FROM `classes`";
...
<body>
    ...
    <div class="aside-right">
        ...
        <div class="section1">
            ...
            <button class="add-class"><a href="class-form.php">Add new class</a></button>
            <table border="1" cellspacing="0" cellpadding="3" width="500">
                ...
                <?php
                    ...
                    $selectQuery = "SELECT * FROM `classes` limit $offset,$limit";
                    $classData = $con->query($selectQuery);
                    if($classData->num_rows > 0) {
                        ...
                        while($classRows = $classData->fetch_assoc()) {
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    <a href="edit-class.php?id=<?php echo $classRows['id']; ?>"><button class="green">Edit</button></a>
                                    <a  class="delete-class"href="delete-class.php?id=<?php echo $classRows['id']; ?>"><button class="red">Delete</button></a>
                                </td>
                            </tr>
                            <?php
                        }
